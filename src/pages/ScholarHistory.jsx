      ...
      <div className="table-card">
        <div className="table-header" style={{ flexDirection: 'column', alignItems: 'flex-start', gap: '15px' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', width: '100%', alignItems: 'center', flexWrap: 'wrap', gap: '10px' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px', flexWrap: 'wrap' }}>
              ...
              {(!isSuperAdmin && data.length > 0) ? (
                <button 
                  onClick={() => navigate(`/scholarships/edit/${data[0]._id}`)}
                  style={{ 
                    padding: '9px 18px', 
                    borderRadius: '10px', 
                    background: '#6366f1', 
          ...
          <div className="filter-bar">
            <div className="search-input-group" style={{ position: 'relative', flex: '1 1 200px' }}>
              ...
              <input 
                ...
                style={{ width: '100%', paddingLeft: '35px', maxWidth: '100%' }}
              />
            </div>
